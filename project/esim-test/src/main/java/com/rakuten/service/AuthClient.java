...
public class AuthClient {
	...
	public AuthClientResponse createAuthClientResonse(AuthClientRequest authClientRequest,
		...
		euiccSignature1Asn1 = "30440220079e914d134d5fd83d2adebd1b4c5ab0eada3bb7783347dd0820e27b5826cc8b0220685be9093ce6744565963a9c33604013d4274cd89f45b926a994c2ba9b494db2";
		
		//6. Verify euiccSignature 1 with euicc Public Key
		//if(EcdsaCrypto.verifySignatureUsingPK(euiccPK,euiccSigned1,euiccSignature1Asn1,Curve)); 
		//	return createErrorResponse("8.10.1","3.9","The RSP session identified by the TransactionID is unknown");
		...
		String smdpSignature2 = EcdsaCrypto.generateSignature(skDPPb,
															  smdpSigned2,
															  Curve);
